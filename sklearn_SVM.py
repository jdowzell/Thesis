...
def GetMetrics(X_arr, Y_arr, param_grid):
    ...
    pipe = Pipeline(steps=[['fixnan',fnan],['normalise',norm],['filter',filt],['everynth',enth],['svm', algorithm]])
    #print(pipe)
...
def main():
    ...
    param_grid = {'C': [0.01, 0.1, 1, 5, 10],#, 50],
                  'gamma': [0.000001, 0.00001, 0.0001, 0.0005, 0.001]
                 }
    ...
    WriteJSON("sklearn-SVM", tStart, tFin, tDelta, TN, FP, FN, TP, acc, pre, rec, moreStats)
