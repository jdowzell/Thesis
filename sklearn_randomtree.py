...
def GetMetrics(X_arr, Y_arr, param_grid):
    ...
    pipe = Pipeline(steps=[['fixnan',fnan],['normalise',norm],['filter',filt],['everynth',enth],['rnd', algorithm]])
    #print(pipe)
...
def main():
    ...
    WriteJSON("sklearn-RNDTREE", tStart, tFin, tDelta, TN, FP, FN, TP, acc, pre, rec, moreStats)
