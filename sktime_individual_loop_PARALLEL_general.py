...
def main():
    ...
    #Parallel(n_jobs=16)(delayed(DoTheStuff)(classifier, full_param_grid[classifier], masterX, masterY) for classifier in list_of_classifiers)
    
    ############################
    # Test New Order of Operations
    ############################
    ...
    confMat, moreStats, acc, pre, rec = zip(*Parallel(n_jobs=-1)(delayed(GetMetrics)(classifier, masterX, masterY, full_param_grid[classifier.__name__]) for classifier in list_of_classifiers))
