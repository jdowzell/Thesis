...
def main():
    ...
    # Make the list of algorithm-specific parameters for GridSearching
#    param_grid = {
...
#    }
    ...
    # Simply passing this entire grid means we have 5^19 different combinations, or approx 19 TRILLION - this (naturally) raises a MemoryError
    # Time to make it such that only the relevant options are passed through to the function, one-at-a-time!
